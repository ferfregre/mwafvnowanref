...
-- DDD (Hitbox Select) + ESP (RGB + Highlight) + NightMode + WallCam + Bhop + Spin + Zoom
-- ============================================
...
Rayfield:Notify({
    Title = "Готово",
    Content = "Скрипт полностью обновлен: добавлен выбор Hitbox для DDD!",
    Duration = 3,
    Image = 4483362458,
})